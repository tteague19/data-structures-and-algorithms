...
public class TraversalsTests {
    ...
    public void testPostorderTraversal() {
        ...
        List<Integer> actualTraversal = new Traversals<Integer>().postorder(node1);
        assertEquals(expectedTraversal, actualTraversal);
    }

    @Test
    public void testPostorderTraversalNoRoot() {

        List<Integer> expectedTraversal = new ArrayList<>();

        List<Integer> actualTraversal = new Traversals<Integer>().postorder(null);
        assertEquals(expectedTraversal, actualTraversal);
    }

    @Test
    public void testPostorderTraversalRootOnly() {
        TreeNode<Integer> node1 = new TreeNode<Integer>(50);
